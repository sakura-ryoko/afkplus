...
public class ReasonPlaceholder
{
    ...
    {
        //#if MC >= 12101
        //$$ Placeholders.register(ResourceLocation.fromNamespaceAndPath(AfkPlusReference.AFK_MOD_ID, "reason"), (ctx, arg) ->
        //#else
        Placeholders.register(new ResourceLocation(AfkPlusReference.AFK_MOD_ID, "reason"), (ctx, arg) ->
                //#endif
        {
            if (!ctx.hasPlayer())
            {
