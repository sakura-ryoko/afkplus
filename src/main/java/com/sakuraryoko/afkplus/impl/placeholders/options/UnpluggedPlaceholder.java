...
@ApiStatus.Internal
public class UnpluggedPlaceholder
{
    public static void register()
    {
        //#if MC >= 26.1
        //$$ Placeholders.registerServer(Identifier.fromNamespaceAndPath(Reference.MOD_ID, "unplugged"), (ctx, arg) ->
        //#elseif MC >= 1.21.1
        //$$ Placeholders.register(ResourceLocation.fromNamespaceAndPath(Reference.MOD_ID, "unplugged"), (ctx, arg) ->
        //#else
        Placeholders.register(new ResourceLocation(Reference.MOD_ID, "unplugged"), (ctx, arg) ->
        //#endif
        {
            //#if MC >= 26.1
            ...
            Component result = afkPlayer.isUnplugged()
                               ? PlaceholderUtils.parseText(TextHandler.getInstance().formatTextSafe(ConfigWrap.place().unpluggedPlaceholder + "<r>"), ctx)
                               : Component.empty();
