...
public class DisplayNamePlaceholder
{
    ...
    {
        //#if MC >= 26.1
        //$$ Placeholders.registerServer(Identifier.fromNamespaceAndPath(Reference.MOD_ID, "name"), (ctx, arg) ->
        //#elseif MC >= 1.21.1
        ...
        //#if MC >= 26.1
        //$$ Placeholders.registerServer(Identifier.fromNamespaceAndPath(Reference.MOD_ID, "display_name"), (ctx, arg) ->
        //#elseif MC >= 1.21.1
